...
msgtxt = MIMEText(msg, 'html', 'utf-8') # 内容，格式，编码

message = MIMEMultipart() # 创建一个带附件的邮件
message.attach(msgtxt) # 添加邮件正文
...
img = MIMEImage(open('d8bb4996-8952-4713-8b8e-4d83e5b921c2.png','r').read())
